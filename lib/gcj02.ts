...
//
// Algorithm is copied verbatim from server/lib/wgs84-to-gcj02.js so
// numbers come out byte-identical for the same inputs.
 ...
 * @returns `[lng, lat]` in GCJ-02 (or unchanged if outside mainland China).
 */
